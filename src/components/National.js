        ...
        <Container>
                <Wrapper videoEnded={videoEnded}>
                    <video autoPlay={true} playsInline={true} loop={false} onEnded={() => setVideoEnded(true)}>
                        <source src="/disney-plus/videos/national-geographic-page.mp4" type="video/mp4"/>
                    </video>
                <Background videoEnded={videoEnded}>
                    <img src="/disney-plus/images/national-geographic-page.jfif" />
                    <div></div>
                </Background>
                <ImageTitle>
                    <img src="/disney-plus/images/national-geographic-logo.png" />
                </ImageTitle>
                <Recommends />
                <NewDisney />
                <Originals />
